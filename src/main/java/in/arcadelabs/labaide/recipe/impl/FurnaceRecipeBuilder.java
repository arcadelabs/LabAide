...
public class FurnaceRecipeBuilder implements RecipeBuilder {
  ...
  public FurnaceRecipeBuilder(JavaPlugin instance) {
  ...
  public RecipeBuilder build() {
    this.recipe = new FurnaceRecipe(this.key, this.result, this.ingredients, this.experience, this.cookingTime);
    return this;
  }
